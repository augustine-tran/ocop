...
class CriteriaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create criterium" do
    assert_difference("Criterium.count") do
      post criteria_url, params: { criterium: { leaf: @criterium.leaf, level: @criterium.level, score: @criterium.score, title: @criterium.title, year: @criterium.year } }
    end
  ...
  test "should update criterium" do
    patch criterium_url(@criterium), params: { criterium: { leaf: @criterium.leaf, level: @criterium.level, score: @criterium.score, title: @criterium.title, year: @criterium.year } }
