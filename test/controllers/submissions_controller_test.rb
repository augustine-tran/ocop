...
class SubmissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create submission" do
    assert_difference("Submission.count") do
      post submissions_url, params: { submission: { submission_type: @submission.submission_type, title: @submission.title } }
    end
  ...
  test "should update submission" do
    patch submission_url(@submission), params: { submission: { submission_type: @submission.submission_type, title: @submission.title } }
